...
Mr, Pin, isp_grid, mr_stoich = get_isp_heatmap(Fuel=Fuel, Ox=Ox, mr_range=mr_range, p_range=p_range, pamb=pamb)
Mr, Pin, tempstar_grid, mr_stoich = get_tempstar_heatmap(Fuel=Fuel, Ox=Ox, mr_range=mr_range, p_range=p_range, pamb=pamb)
