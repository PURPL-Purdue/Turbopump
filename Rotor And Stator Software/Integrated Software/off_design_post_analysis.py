...
data_folder = "output_tables/"

# load data
mdot_range = np.loadtxt(data_folder + "off_design_mdot_range.csv", delimiter=",") / 0.45359237 # lbm/s
rpm_range = np.loadtxt(data_folder + "off_design_rpm_range.csv", delimiter=",")
HP = np.loadtxt(data_folder + "hp_surface.csv", delimiter=",")
