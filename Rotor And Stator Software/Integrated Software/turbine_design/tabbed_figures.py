"""
Helper for creating figures as tabs in a window
Source of this code is from a stack overflow post: https://stackoverflow.com/a/58019900
"""
...
class plotWindow():
    def __init__(self, window_title="plot window", parent=None):
