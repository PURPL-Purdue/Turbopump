...
def main():
    ...
    #mdot_200psi =  0.01762    #kg/s MDOT @ 20% heat transfer efficiency, 200psi pc
    #mdot =  0.00352    #kg/s MDOT @ 100% heat transfer efficiency, 200psi pc
    ...
    ox_CEA = 'GOX'
    fuel_CEA = 'CH4'
    k_f = 1.31  # ch4 specific heat ratio
    ...
    fuel_PYF = Fluid(FluidsList.Methane).with_state(Input.pressure(p_line), Input.temperature(T_AMB_CELSIUS))
    ...
    theta_ox = 0 # oxidizer injection angle [deg]
