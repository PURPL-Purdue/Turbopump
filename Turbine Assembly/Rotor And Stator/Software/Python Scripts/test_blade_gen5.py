...
def compute_distances_and_plot(x_lower, y_lower, upper_curve, target_distance, blade_spacing, ax):
    ...
    print(f"Isentropic Efficiency from Thermodynamics: {n_th}")
    ...
    print(f"Percent of Design: {HORSE_POWER * (1 - y_loss)} HP")
    print(f"Efficiency: {(1 - y_loss)}")
